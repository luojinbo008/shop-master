...
<div class="panel-heading">
    <h3 class="panel-title">
        <i class="fa fa-pencil"></i> 新增商品
    </h3>
</div>
<div class="panel-body">
    <form action="{{ url({'for' : 'backend/product/add'}) }}" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="sku" value="{% if sku is defined %}{{sku}}{% else %}{% endif %}" placeholder="库存单位" id="input-sku" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="subtract" id="input-subtract" class="form-control">
                            {% if subtract is not defined %}
                                <option value="1" selected="selected">开启</option>
                                <option value="0">停用</option>
                            {% elseif subtract is defined and subtract == 1 %}
                                <option value="1" selected="selected">开启</option>
                                <option value="0">停用</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
                            {% if product_category is defined %}
                        ...
                        <div id="product-related" class="well well-sm" style="height: 150px; overflow: auto;">
                            {% if product_related is defined %}
                                {% for product_related_data in product_related %}
                                    <div id="product-related{{ product_related_data['product_id'] }}"><i class="fa fa-minus-circle"></i> {{ product_related_data['name'] }}
                                    ...
                                    <li>
                                        <a href="#tab-option{{option_row}}" data-toggle="tab">
                                            <i class="fa fa-minus-circle" onclick="$('a[href=\'#tab-option{{option_row}}\']').parent().remove();
                                                $('#tab-option{{option_row}}').remove(); $('#option a:first').tab('show');">
                                            </i>
                        ...
                        {% for product_option_data in product_option %}
                            ...
                            {% if product_option_data['type'] == 'textarea' %}
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-value{{ option_row }}">选项值</label>
                                    <div class="col-sm-10">
                                        <textarea name="product_option[{{ option_row }}][value]" rows="5" placeholder="选项值"
                                                  id="input-value{{ option_row }}" class="form-control">{{ product_option_data['value'] }}</textarea>
                                    </div>
                                </div>
                            {% endif %}
                            ...
                            {% if product_option_data['type'] == 'select' or product_option_data['type'] == 'radio'
                                ...
                                <div class="table-responsive">
                                    <table id="option-value{{ option_row }}" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                        {% if product_option_data['product_option_value'] is defined %}
                                            ...
                                            <tr id="option-value-row{{ option_value_row }}">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <input type="text" name="product_option[{{ option_row }}][product_option_value][{{ option_value_row }}][points]"
                                                           value="{{ product_option_value['points'] }}" placeholder="所需积分" class="form-control" /></td>
                                                <td class="text-left">
                                                <button type="button" onclick="$(this).tooltip('destroy');$('#option-value-row{{ option_value_row }}').remove();" data-toggle="tooltip" title="移除" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                                                </td>
                                            </tr>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-left">
                                                    <button type="button" onclick="addOptionValue('{{ option_row }}');" data-toggle="tooltip" title="新增" class="btn btn-primary">
            ...
            <div class="tab-pane" id="tab-discount">
              <div class="table-responsive">
                <table id="discount" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    {% set discount_row = 0 %}
                    {% if product_discount is defined %}
                        {% for product_discount_data in product_discount %}
                            <tr id="discount-row{{discount_row}}">
                                ...
                                <td class="text-right">
                                    <input type="text" name="product_discount[{{discount_row}}][quantity]" value="{{product_discount_data['quantity']}}" placeholder="数量" class="form-control" />
                                </td>
                                <td class="text-right">
                                    <input type="text" name="product_discount[{{discount_row}}][priority]" value="{{product_discount_data['priority']}}" placeholder="优先级" class="form-control" />
                                </td>
                                <td class="text-right">
                                    <input type="text" name="product_discount[{{discount_row}}][price]" value="{{product_discount_data['price']}}" placeholder="价格" class="form-control" />
                                </td>
                                ...
                                <td class="text-left">
                                    <button type="button" onclick="$('#discount-row{{ discount_row }}').remove();" data-toggle="tooltip" title="移除" class="btn btn-danger">
                  ...
                  <tfoot>
                    <tr>
                        <td colspan="6"></td>
                        <td class="text-left">
                            <button type="button" onclick="addDiscount();" data-toggle="tooltip" title="新增" class="btn btn-primary">
                                <i class="fa fa-plus-circle"></i>
                            </button>
                        </td>
                    </tr>
                ...
                <table id="special" class="table table-striped table-bordered table-hover">
                    ...
                    {% if product_special is defined %}
                        {% for product_special_data in product_special %}
                            <tr id="special-row{{special_row}}">
                              ...
                              <td class="text-right">
                                  <input type="text" name="product_special[{{ special_row }}][priority]" value="{{ product_special_data['priority'] }}" placeholder="优先级" class="form-control" />
                              </td>
                              <td class="text-right">
                                  <input type="text" name="product_special[{{ special_row }}][price]" value="{{ product_special_data['price'] }}" placeholder="价格" class="form-control" />
                              </td>
                              <td class="text-left" style="width: 20%;">
                                  <div class="input-group date">
                                    <input type="text" name="product_special[{{ special_row }}][date_start]" value="{{ product_special_data['date_start'] }}"
                                           placeholder="开始时间" data-date-format="YYYY-MM-DD" class="form-control" />
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                    </span>
                                  </div>
                              ...
                              <td class="text-left" style="width: 20%;">
                                  <div class="input-group date">
                                      <input type="text" name="product_special[{{ special_row }}][date_end]" value="{{ product_special_data['date_end'] }}" placeholder="结束时间"
                              ...
                              <td class="text-left">
                                  <button type="button" onclick="$('#special-row{{ special_row }}').remove();" data-toggle="tooltip" title="移除" class="btn btn-danger">
                                      <i class="fa fa-minus-circle"></i>
                                  </button>
                              </td>
                            </tr>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="5"></td>
                      <td class="text-left">
                          <button type="button" onclick="addSpecial();" data-toggle="tooltip" title="新增" class="btn btn-primary">
                              <i class="fa fa-plus-circle"></i>
                          </button>
                      </td>
                    </tr>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    {% set image_row = 0 %}
                        ...
                        <?php if (isset($product_image)) { foreach ($product_image as $product_image_data) { ?>
                            <tr id="image-row<?php echo $image_row; ?>">
                              <td class="text-left">
                                  ...
                                  <input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image_data['image']; ?>"
                                         id="input-image<?php echo $image_row; ?>" />
                              </td>
                              <td class="text-right">
                                  <input type="text" name="product_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $product_image_data['sort_order']; ?>"
            ...
            <div class="tab-pane" id="tab-reward">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="points" value="{% if points is defined %}{{ points }}{% endif %}" placeholder="所需积分" id="input-points" class="form-control" />
                </div>
              </div>
              <div class="table-responsive">
