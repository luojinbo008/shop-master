...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="{{url({'for' : 'backend/filter/add'})}}" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
            ...
            <table id="filter" class="table table-striped table-bordered table-hover">
                ...
                <tr id="filter-row{{ filter_row }}">
                    <td class="text-left" style="width: 70%;">
                        ...
                        <div class="input-group  col-sm-12">
                            <input type="text" name="filters[{{ filter_row }}][filter_name]" value="{{ filter['filter_name'] }}" placeholder="筛选名称" class="form-control" />
                        </div>
