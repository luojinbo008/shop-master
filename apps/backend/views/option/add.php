...
<h3 class="panel-title">
    <i class="fa fa-pencil"></i> 新增选项
</h3>
</div>
<div class="panel-body">
<form action="{{ url({'for' : 'backend/option/add'}) }}" method="post" enctype="multipart/form-data" id="form-option" class="form-horizontal">
