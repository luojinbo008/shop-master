...
<script type="text/javascript">
    // 绑定删除事件
    $("#backend-option-delete").click(function () {
    ...
    var TableManaged = function () {
        return {
            init: function () {
                ...
                $('#sample_1').dataTable({
                    "aoColumns": [
                        { "mDataProp": "option_id", "sClass" : "text-center", "bSortable": false, "fnRender": function(obj) {
                            obj.aData.edit_id = obj.aData.option_id;
                            var html = '<input type="checkbox" name="selected[]" value="' + obj.aData.option_id + '" />';
                            return html;
                        }},
                        ...
                        { "mDataProp": "edit_id", "sClass" : "text-center", "bSortable": false, "fnRender": function(obj) {
                            ...
                            html = "<a href=\"{{ url({'for' : child['for']}) }}?option_id="
                    ...
                    "bPaginate" : true,
                    "bDestroy":true,
                    "sAjaxSource" : "{{ url({'for': 'backend/option'}) }}",
    ...
    function del() {
        $("#form-option").ajaxSubmit({
            type:"post",
            url:"{{ url({'for' : 'backend/option/delete'}) }}",
