...
<div class="panel-body">
  <form action="{{ url({'for' : 'backend/category/edit'}) }}" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="tab-data">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="path" value="{% if path is defined %}{{ path }}{% endif %}" placeholder="上一级" id="input-parent" class="form-control" />
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="checkbox">
              <label>
                <input type="checkbox" name="top" value="1" id="input-top" {% if top is defined and top == 1 %} checked {% endif %}/>
                &nbsp; </label>
            </div>
          </div>
        </div>
