...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> 编辑商店</h3>
    </div>
    <div class="panel-body">
        <form action="{{ url({'for' : 'backend/store/edit'}) }}" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
                ...
                <div class="tab-pane active" id="tab-general">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-url">
                            <span data-toggle="tooltip" data-html="true" title="请输入你网店的完整网址。
                            注意在最后加上 '/' 。 例： http：//www.azbzo.com/path/<br /><br />请用新的域名或二级域名指定到你的主机。">
                                网店网址 URL
                            </span>
                        </label>
                        <div class="col-sm-10">
                            <input type="hidden" name="store_id" value="{% if store_id is defined %}{{store_id}}{% endif %}">
                            ...
                            {% if error_store_url is defined %}
                                <div class="text-danger">{{ error_store_url }}</div>
                            {% endif %}
                        </div>
                    </div>
                    <div class="form-group required">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" id="form-advert" class="form-horizontal">
                                ...
                                {% set image_row = image_row + 1 %}
                                    <tr id="image-row{{image_row}}">
                                        ...
                                        <td class="text-left">
                                            <a href="javascript:" id="thumb-image{{image_row}}" data-target="image{{image_row}}" data-toggle="image" class="img-thumbnail">
...
<script type="text/javascript">
    ...
    function addImage() {
        ...
        html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '" data-toggle="image' + image_row + '" class="img-thumbnail"><img src="{{ placeholder }}" alt="" title="" data-placeholder="{{ placeholder }}" /></a>' +
