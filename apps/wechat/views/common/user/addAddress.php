...
<form id="form" method="post" action="" onsubmit="return false;">
    <ul class="contact">
        ...
        <li>
            <input type="text" name="idcard" placeholder="请输入用户身份证号"/>
        </li>
        <li>
            <input type="text" name="wechat_user" placeholder="请输入用户微信账号"/>
        </li>
        <li>
            <input type="text" name="shipping_telephone" placeholder="请输入手机号"/>
        </li>
    </ul>
